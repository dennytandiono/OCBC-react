    ...
    <>
      <div className="p-5 mb-4 bg-light rounded-3 border">
        <div className="container-fluid py-5">
          <h1 className="diplay-5 fw-bold">First Paragraph in Jumbotron</h1>
          <p className="col-md-8 fs-4">kepanjangan</p>
  ...
  return (
    <footer className="text-muted py-5 border-top">
      <div className="container">
        <p>My 1st react app in bootstrap</p>
        <p>New to react? <a href="https://reactjs.org/">Visit the homepage</a></p>
      </div>
    </footer>
  )
}
